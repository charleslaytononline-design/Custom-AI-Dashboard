...
const s: Record<string, React.CSSProperties> = {
  ...
  card: { background: 'var(--bg-2)', border: '1px solid var(--border)', borderRadius: 12, padding: 24 },
  cardTitle: { fontSize: 11, color: 'var(--text-3)', textTransform: 'uppercase' as const, letterSpacing: '0.05em', marginBottom: 16 },
  ...
  emailText: { fontSize: 15, fontWeight: 500, color: 'var(--text)' },
  joinedText: { fontSize: 11, color: 'var(--text-3)', marginTop: 6 },
  topUpBtn: { width: '100%', padding: '10px 0', background: 'var(--accent)', border: 'none', borderRadius: 8, color: 'white', fontSize: 13, fontWeight: 500, cursor: 'pointer' },
  statsGrid: { display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 16, padding: '16px 32px 0' },
  statCard: { background: 'var(--bg-2)', border: '1px solid var(--border)', borderRadius: 10, padding: '16px 18px' },
  statLabel: { fontSize: 11, color: 'var(--text-3)', textTransform: 'uppercase' as const, letterSpacing: '0.05em', marginBottom: 6 },
  statVal: { fontSize: 24, fontWeight: 700, color: 'var(--text)', marginBottom: 2 },
  ...
  empty: { color: 'var(--text-3)', fontSize: 13, padding: '24px 0' },
  tableWrap: { background: 'var(--bg-2)', border: '1px solid var(--border)', borderRadius: 10, overflowX: 'auto' as const },
  table: { width: '100%', borderCollapse: 'collapse' as const },
  thead: { background: 'var(--bg-3)' },
  th: { padding: '10px 16px', textAlign: 'left' as const, fontSize: 10, fontWeight: 500, color: 'var(--text-3)', textTransform: 'uppercase' as const, letterSpacing: '0.05em' },
  tr: { borderTop: '1px solid var(--border)' },
  td: { padding: '10px 16px', verticalAlign: 'middle' as const },
  dateText: { fontSize: 12, color: 'var(--text-3)' },
  dimText: { fontSize: 12, color: 'var(--text-3)' },
  ...
  badgeGray: { background: 'rgba(255,255,255,0.05)', color: 'var(--text-3)' },
}
